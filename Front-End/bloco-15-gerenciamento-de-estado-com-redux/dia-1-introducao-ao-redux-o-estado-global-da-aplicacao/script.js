...
const meuReducer = (state = ESTADO_INICIAL, action) => {
  ...
  // Essas actions devem alterar o valor index guardado no ESTADO_INICIAL . Atente-se aos limites de tamanho do array,
  // as posições devem iniciar em 0 e não podem exceder a numeração do último item do array.
...
...
  ...
  // Você deverá ser capaz de ver as cores mudando ao fundo, e o nome da cor exibida.
  ...
  //6 - Crie um botão com o texto Random color , um eventListener e uma action no reducer adicionando uma cor aleatória ao array colors
  // guardado em nosso estado inicial. Faça também com que essa cor seja mostrada ao ser criada, alterando o estado index para a posição dela.
