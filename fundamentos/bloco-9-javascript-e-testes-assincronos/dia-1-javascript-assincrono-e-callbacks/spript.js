...
// codigo é sincrono, com isso segue a ordem normal ( A, B e C) */
...
// o código é assincrono por isso a ordem será(A,C e B) */
...
//3 - A função getPlanet abaixo imprime o planeta Marte de forma síncrona.
  ...
  //4 - Suponha que você precise simular uma mensagem enviada do robô Curiosity de Marte para a Terra. 
    ...
    const sendMarsTemperature = () => {
        const chamaGetMarsTemperature = getMarsTemperature();
        setTimeout(() => {
            console.log(`A temperatura em Marte é: ${chamaGetMarsTemperature}°C`)
        }, messageDelay);
    }
